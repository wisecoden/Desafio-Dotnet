...
public class RabbitMQInitializer : IRabbitMQInitializer
{
    ...
    public async Task InitializeAsync()
    {
        ...
        await channel.QueueDeclareAsync(
            queue: ExchangeSettings.STOCK_UPDATE_QUEUE,
            durable: true,
            exclusive: false,
            autoDelete: false);
        ...
        await channel.QueueBindAsync(
            queue: ExchangeSettings.STOCK_UPDATE_QUEUE,
            exchange: ExchangeSettings.STOCK_EXCHANGE,
            routingKey: ExchangeSettings.STOCK_UPDATED_ROUTING_KEY);

        Console.WriteLine("✅ RabbitMQ Exchanges e Queues do Stock inicializados com sucesso!");
    }
}
